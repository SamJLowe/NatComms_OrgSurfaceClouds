...
%     
    ...
    % p(jj, ienv, ii) = patch([jj jj+1 jj+1 jj],[ym ym yp yp],'r'); hold on; box on

     %set(p(jj, ienv, ii), 'FaceColor', 'none', 'EdgeColor', COLORS(ienv,:),...
...
set(gca,'XTick',xtix,'XTickLabel', labels, 'XTickLabelRotation', 0,'Xgrid','on',...
    'YTick',0.25:0.25:2.5,'YLim',[0.25 2.5])
