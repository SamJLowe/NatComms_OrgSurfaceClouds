function [CLOUDTOP, OPTICS] = RUN_CLOUD(ENV, doOPTICS)
...
elseif strcmp(ENV, 'NUM event')
    cd NUM
elseif strcmp(ENV, 'MACEHEAD_TS')                 %Mace Head Summer (May - Aug, 2012)
    cd MAV
end
...
if doOPTICS
    ...
    if NAT == 1
        ...
        %--------------------------------------------------------------------------
        %RACT                  = [bulk_cdnc(7) 0]*1e9;                                                 %Samllest activated size class [nm]
