...
function N1N2_GenInputFiles(iCOMPFILM, UPDRAFT, ENV, N1, N2)

TEMP0       = 280;         %Initial temperature       [K] 
PRESS0      = 98000;       %Initial pressure          [Pa]
CLOUD_DEPTH = 200;         %Simulation depth          [m]    
...
if strcmp(ENV, 'Marine')
    ...
    cd MAV
    MODAL_PARS.CONC         = [226.036 134.600];   %[number/cm3]
    MODAL_PARS.GSD          = [1.705   1.703];     
    MODAL_PARS.GEOMEAN_DIAM = [0.0393  0.139];     %[um]
