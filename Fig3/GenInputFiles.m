...
function GenInputFiles(iCOMPFILM, UPDRAFT, ENV, N2, FORG)

TEMP0       = 280;         %Initial temperature       [K] 
PRESS0      = 98000;       %Initial pressure          [Pa]
CLOUD_DEPTH = 100;         %Simulation depth          [m]    
...
if strcmp(ENV, 'Marine')
    ...
    MODAL_PARS.GEOMEAN_DIAM = [0.039, 0.1385];     %[um]
    DENSITY(4:5)            = 0.852;               %Set organic density. Palmitic acid 256.4 [gmol-1]
    MASS_FRAC               = [0 0 1-FORG FORG 0 0 0 0;...
                               0 0 0      FORG 0 0 0 1-FORG];
    NAT                     = 2;
    NMODE                   = [1 1];
